<?php
 ...
 $cp_data = $query->addquery('select','dmethods','*','s','coinpayments','methods=?');
 $cp_debug_email = '';
 ...
 $item_number = $_POST['item_number'];
  ...
  //success
  $query->addquery('insert','payments','user_id,item_number,txn_id,payment_gross,crypto_am,currency_code,payment_status,type,created','issssssss',[$invoice->user_id,$item_number,$txn_id,$amount1,$amount2,$currency1,$status_text,'Coinpayments',$dateForm]);
  ...
  //pending
  $query->addquery('update','invoice','status_text=?','si',[$status_text,$item_number],'id=?');
  $query->addquery('insert','payments','user_id,item_number,txn_id,payment_gross,crypto_am,currency_code,payment_status,type,created','issssssss',[$invoice->user_id,$item_number,$txn_id,$amount1,$amount2,$currency2,$status_text,'Coinpayments',$dateForm]);
 } 
