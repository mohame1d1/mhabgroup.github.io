<?php
 ...
 if(isset($_POST['register'])) {
  ...
  $query->addquery('insert','members','username,password,email,role,recover,created','ssssss',[$username,$password,$email,'admin',$recover,$dateForm]);
  if(!endsWith($website, '/')):
   $website = $website.DS;
  endif;
   $appConfig = get_app($website,Theme,'on','1.2.0',$sr->csrf_token(),'MidFaucet',$dateForm,$dateForm);
