 {include file='../Layout/header.tpl'}
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                               <div class="card-box">
     {if $updated}<div class="alert alert-success">QA Updated Successfully</div>{/if}
     {if $added}<div class="alert alert-success">QA Added Successfully</div>{/if}
     {if $deactivated}<div class='alert alert-success'>QA Deactivated Successfully</div>{/if}
     {if $activated}<div class='alert alert-success'>QA Activated Successfully</div>{/if}
     {if $deleted}<div class="alert alert-success">QA Deleted Successfully</div>{/if}
     ...
     {include file='../Qa/menu.tpl'}
              ...
              {/if}
                   ...
                   <td>
                   <form action="{$ADM}qa/edit/{$foo['id']}/" method="POST">
                    <button class="btn btn-success btn-xs">Edit</button>
                                               ...
                                               {if !$qalist}<span class="badge badge-danger elem-center" style="margin-left: 200px;">No Qa was Found..</span>{/if}
                               </div>
                            </div>
                        </div>
                        <!-- end row -->
