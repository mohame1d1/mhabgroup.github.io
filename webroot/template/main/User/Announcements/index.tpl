                                     ...
                                     <div class="table-responsive">
                                                    <table class="table m-0">
                                                        ...
                                                        <thead class="thead-light">
                                                            <tr>
                                                                <th>#</th>
                                                                <th><i class="fa fa-bell"></i> {$_ANNOUNCEMENTS}</th>
                                               ...
                                               {if !$announcements}<span class="badge badge-danger elem-center" style="margin-left: 200px;">{$_NO_RECORDS_WERE_FOUND}</span>{/if}
                               </div>
                            </div>
                        </div>
                        <!-- end row -->
